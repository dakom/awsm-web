...
use awsm_web::webgl::{BeginMode, BufferMask, Id, GlToggle, BlendFactor, WebGlVersion};
        ...
        body,
        {
            ...
            move |webgl_renderer, on_ready| {
                ...
                let program_id = webgl_renderer.compile_program(
                    include_str!("shaders/simple-vec-vertex.glsl"),
                    include_str!("shaders/simple-vec-fragment.glsl"),
                )?;

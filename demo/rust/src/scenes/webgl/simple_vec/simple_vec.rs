...
use awsm_web::webgl::{BeginMode, BufferMask, Id, GlToggle, BlendFactor, WebGlVersion, ShaderType};
    ...
    start_webgl!(
        ...
        body,
        {
            ...
            move |webgl_renderer, on_ready| {
                ...
                let shaders = vec![
                    webgl_renderer.compile_shader(include_str!("shaders/simple-vec-vertex.glsl"), ShaderType::Vertex).unwrap(),
                    webgl_renderer.compile_shader(include_str!("shaders/simple-vec-fragment.glsl"), ShaderType::Fragment).unwrap(),
                ];
